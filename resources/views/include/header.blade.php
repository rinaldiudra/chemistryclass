        ...
        <div class="container clearfix">
          ...
          <nav id="primary-menu" class="dark">
            ...
            <ul>
              ...
              <li class="mega-menu"><a href="{{ route('download') }}"><div>Download Materi</div></a></li>
              <li class="mega-menu"><a href="{{ route('ujian') }}"><div>Ujian</div></a></li>
              <li class="mega-menu"><a href="{{ route('login') }}"><div>Peringkat</div></a></li>
              <li class="mega-menu"><a href="{{ route('login') }}"><div>Akun Saya</div></a>
                  <ul class="mega-menu-column col-5">
                      <li><a href="style-boxes.html"background="white"><div>Keluar</div></a></li>
                    </ul>
                  </li>
            </ul>
