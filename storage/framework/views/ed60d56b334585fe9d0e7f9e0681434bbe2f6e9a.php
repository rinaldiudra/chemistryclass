		...
		<header id="header" class="transparent-header full-header" data-sticky-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<!-- <div id="logo">
						<a href="#" class="standard-logo" data-dark-logo="images/logo-dark.png"><img src="<?php echo e(asset('users/images/logo.png')); ?>" alt="Canvas Logo"></a>
						<a href="#" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img src="<?php echo e(asset('users/images/logo@2x.png')); ?>" alt="Canvas Logo"></a>
					</div> --><!-- #logo end -->
...
</html><?php /**PATH C:\xampp\htdocs\chemistryclass\resources\views/layouts/layout_user.blade.php ENDPATH**/ ?>