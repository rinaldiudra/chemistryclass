						...
						<div class="entry clearfix">
							...
							<div class="entry-content notopmargin">
								...
								<div class="entry-image alignleft">
									<a href="#"><img src="<?php echo e(asset('users/images/portfolio/full/1.jpg')); ?>" alt="Blog Single"></a>
								</div><!-- .entry-image end -->
...
<?php echo $__env->make('include.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\chemistryclass\resources\views/users/bacamateri.blade.php ENDPATH**/ ?>